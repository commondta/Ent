...
<head>
    ...
    <style>
        /* Disable animations and transitions on the login page */
                    ...
                    <x-auth-card>
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div>
                                ...
                                <x-input id="email"  class="block mt-1 w-full form-control form-icon-input" type="email" name="email" :value="old('email')" required autofocus />
                            </div>
                            ...
                            <div class="mt-4">
                                ...
                                <x-input id="password" class="block mt-1 w-full form-control form-icon-input"
                                         type="password"
                                         name="password"
                            ...
                            <div class="flex items-center justify-end mt-4">
                                ...
                                <x-button style="width: 100%" class="ml-3 btn btn-primary">
                                    {{ __('Log in') }}
                                </x-button>
                            </div>
                        </form>
                    ...
                    <div class="d-flex flex-column-reverse scrollbar h-100 p-3">
                        ...
                        <div class="text-center mt-auto">
                            <div class="avatar avatar-3xl status-online"><img
                                        ...
                                        src="{{ asset('public/assets/img/team/30.webp'); }}" alt=""/></div>
...
{{--<script src="{{ asset('public/'); }}{{ asset('public/'); }}polyfill.io/v3/polyfill.min58be.js?features=window.scroll"></script>--}}
