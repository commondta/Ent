                    ...
                    <div class="card shadow-none border border-300 my-4" data-component-card="data-component-card">
                        <div class="card-header p-4 border-bottom border-300 bg-soft">
                            <div class="row g-3 justify-content-between align-items-end">
                                <div class="col-12 col-md">
                                    <h4 class="text-900 mb-0" data-anchor="data-anchor">Approved Documents</h4>
                                </div>
                        ...
                        <div class="card-body p-0">
                            ...
                            <ul style="margin-left: 30px" class="nav nav-underline" id="myTab" role="tablist">
                                ...
                                <li class="nav-item position-relative" role="presentation">
                                    <a class="nav-link approved_document_view_status" id="exemption_rate-tab" data-bs-toggle="tab" href="#tab-exemption_rate"
                                ...
                                <li class="nav-item position-relative" role="presentation">
                                    <a class="nav-link approved_document_view_status" id="challan_fee-tab" data-bs-toggle="tab" href="#tab-challan_fee"
                                ...
                                <li class="nav-item position-relative" role="presentation">
                                    <a class="nav-link approved_document_view_status" id="seller_profile-tab" data-bs-toggle="tab" href="#tab-seller_profile"
                                ...
                                <li class="nav-item position-relative" role="presentation">
                                    <a class="nav-link approved_document_view_status" id="challan_form-tab" data-bs-toggle="tab" href="#tab-challan_form"
                                ...
                                <li class="nav-item position-relative" role="presentation">
                                    <a class="nav-link approved_document_view_status" id="land_form_seller-tab" data-bs-toggle="tab" href="#tab-land_form_seller"
                                ...
                                <li class="nav-item position-relative" role="presentation">
                                    <a class="nav-link approved_document_view_status" id="purchase_of_land-tab" data-bs-toggle="tab" href="#tab-purchase_of_land"
                                ...
                                <li class="nav-item position-relative" role="presentation">
                                    <a class="nav-link approved_document_view_status" id="possession_certificate-tab" data-bs-toggle="tab" href="#tab-possession_certificate"
                                ...
                                <li class="nav-item position-relative" role="presentation">
                                    <a class="nav-link approved_document_view_status" id="pictorial_view-tab" data-bs-toggle="tab" href="#tab-pictorial_view"
                                ...
                                <li class="nav-item position-relative" role="presentation">
                                    <a class="nav-link approved_document_view_status" id="conveyance_deed-tab" data-bs-toggle="tab" href="#tab-conveyance_deed"
                                ...
                                <li class="nav-item position-relative" role="presentation">
                                    <a class="nav-link approved_document_view_status" id="agreement-tab" data-bs-toggle="tab" href="#tab-agreement"
                                ...
                                <li class="nav-item position-relative" role="presentation">
                                    <a class="nav-link approved_document_view_status" id="indemnity_bond-tab" data-bs-toggle="tab" href="#tab-indemnity_bond"
                                ...
                                <li class="nav-item position-relative" role="presentation">
                                    <a class="nav-link approved_document_view_status" id="registry_document-tab" data-bs-toggle="tab" href="#tab-registry_document"
                                ...
                                <li class="nav-item position-relative" role="presentation">
                                    <a class="nav-link approved_document_view_status" id="exemption_form-tab" data-bs-toggle="tab" href="#tab-exemption_form"
                                ...
                                <li class="nav-item position-relative" role="presentation">
                                    <a class="nav-link approved_document_view_status" id="affidavit_2-tab" data-bs-toggle="tab" href="#tab-affidavit_2"
                                ...
                                <li class="nav-item position-relative" role="presentation">
                                    <a class="nav-link approved_document_view_status" id="intimation_application-tab" data-bs-toggle="tab" href="#tab-intimation_application"
                                ...
                                <li class="nav-item position-relative" role="presentation">
                                    <a class="nav-link approved_document_view_status" id="intimation_letter-tab" data-bs-toggle="tab" href="#tab-intimation_letter"
                                ...
                                <li class="nav-item position-relative" role="presentation">
                                    <a class="nav-link approved_document_view_status" id="exemption_inventory-tab" data-bs-toggle="tab" href="#tab-exemption_inventory"
                            ...
                            <div class="tab-content mt-3" id="myTabContent">
                                ...
                                <div class="tab-pane fade" id="tab-exemption_inventory" role="tabpanel"
                                    ...
                                    <div class="card shadow-none border border-300 my-4">
                                        <div class="card-header p-4 border-bottom border-300 bg-soft">
                                            <h4 class="card-title">Exemption Inventory</h4>
                                        </div>
                                        <div class="card-body p-0">
                                            <div class="p-4">
                                                <div class="table-responsive">
                                                    <table class="table table-striped table-sm fs--1 mb-0 w-100">
                                                        <thead>
                                                            <tr>
                                                                <th class="sort border-top ps-3">Doc No</th>
                                                                <th class="sort border-top">Date</th>
                                                                <th class="sort border-top">Land Form NO</th>
                                                                <th class="sort border-top">Total Cost</th>
                                                                <th class="sort text-end align-middle pe-0 border-top">ACTION</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            @forelse($exemption_inventory as $row)
                                                            <tr>
                                                                <td class="align-middle ps-3">{{ $row->doc_no }}</td>
                                                                <td class="align-middle">{{ $row->date }}</td>
                                                                <td class="align-middle">{{ $row->land_offer_form_no }}</td>
                                                                ...
                                                                <td class="align-middle white-space-nowrap text-end pe-0">
                                                                    <div class="btn-reveal-trigger position-static">
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-end">
                                                                            <a class="dropdown-item" href="{{ route('exemption_inventory.show',$row->id) }}">View</a>
...
<script>
    $(document).ready(function() {
        ...
        $.ajax({
            url: '{{ route("approved_docuement_view") }}', // Update this with your route name
            type: 'POST',
            data: {
                elementText: 'LP Master Data',
                _token: '{{ csrf_token() }}' // Ensure CSRF token is included
            },
            success: function(response) {}
        ...
        $('.approved_document_view_status').click(function() {
