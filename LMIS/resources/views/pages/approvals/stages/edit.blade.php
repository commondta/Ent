                            ...
                            <div class="card-header p-4 border-bottom border-300 bg-soft">
                                <div class="row g-3 justify-content-between align-items-center">
                                    <div class="col-12 col-md">
                                        <h4 class="text-900 mb-0" data-anchor="data-anchor">Update Stage</h4>
                                    </div>
                                ...
                                <div class="p-4 code-to-copy">
                                    ...
                                    @endif
                                        <form onsubmit="return validateForm()" class="row g-3 needs-validation"
                                              method="post" action="{{ route('approval_stage.update',$approval_stage->id) }}" novalidate=""
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input class="form-control"
                                                                   ...
                                                                   type="number"
                                                                   value="{{ $approval_stage->no_of_approvals }}"
                                                                   required=""/>
                                                        </div>
                                                    </div>
                                                </div>
