                            ...
                            <div class="card-header p-4 border-bottom border-300 bg-soft">
                                <div class="row g-3 justify-content-between align-items-end">
                                    <div class="col-12 col-md">
                                        <h4 class="text-900 mb-0" data-anchor="data-anchor">Stages List</h4>
                                    </div>
                                    @if(auth()->user()->is_admin == 1)
                                        ...
                                        <div class="col col-md-auto">
                                            <nav class="nav nav-underline justify-content-end doc-tab-nav align-items-center"
                                                ...
                                                <a href="{{ route('approval_stage.create') }}"
                                                    ...
                                                    @if($record)
                                                        @foreach($record as $row)
                                                            <tr>
                                                                ...
                                                                <td class="align-middle ps-3">{{ $row->name }}</td>
                                                                    ...
                                                                    <div class="font-sans-serif btn-reveal-trigger position-static">
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-end py-2">
                                                                            ...
                                                                            <a class="dropdown-item"
                                                                                href="{{ route('approval_stage.edit', $row->id) }}">Edit</a>
                                                                            <form id="deleteForm-{{ $row->id }}"
                                                                                action="{{ route('approval_stage.destroy', $row->id) }}"
                                                                                method="Post">
                                                                                @csrf
                                                                                @method('DELETE')
