                                ...
                                <div class="p-4 code-to-copy">
                                    ...
                                    @endif
                                        <form onsubmit="return validateForm()" class="row g-3 needs-validation"
                                              method="post" action="{{ route('exemption_form.update',$exemption_form->id) }}" novalidate=""
                                            ...
                                            <div class="col-md-12">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input class="form-control" id="doc_no" type="text" name="doc_no"  value="{{$exemption_form->doc_no}}"  readonly required="" />
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <select id="base_doc_no" name="base_doc_no" class="form-control"
                                                            ...
                                                            @foreach($purchase_of_land as $row)
                                                                <option @if($exemption_form->base_doc_no == $row->File_No) selected @endif value="{{ $row->File_No }}">Base Doc No - {{ $row->File_No }}</option>
                                                            @endforeach
                                                        </select>
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <input class="form-control"
                                                                                   ...
                                                                                   name="exemption_rate"
                                                                                   type="text" 
                                                                                   value="{{ $exemption_form->exemption_rate}}"
                                                                                   required=""/>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <input class="form-control"
                                                                                   ...
                                                                                   name="total_files"
                                                                                   type="text"
                                                                                   value="{{ $exemption_form->total_files}}"
                                                                                   required=""/>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <input class="form-control"
                                                                                   ...
                                                                                   name="file_security"
                                                                                   type="text"
                                                                                   value="{{ $exemption_form->file_security}}"
                                                                                   required=""/>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <input class="form-control"
                                                                                   ...
                                                                                   type="text"
                                                                                   value="{{ $exemption_form->transfer_of_decimals}}"
                                                                                   required=""/>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12" style="margin-top: 20px">
                                                                            ...
                                                                            <div class="card-body">
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <table>
                                                                                        ...
                                                                                        ?>
                                                                                        @foreach($exemption_form->rows as $row)
                                                                                            ...
                                                                                            <tr id="1">
                                                                                                ...
                                                                                                <td><input class="row-level form-control" name="item_lines[{{$lineCount}}][qatat]" value="{{ $row['qatat'] }}"></td>
