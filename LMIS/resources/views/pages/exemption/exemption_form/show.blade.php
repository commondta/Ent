                                    ...
                                    @if(auth()->user()->exemption_form_add == 1)
                                        ...
                                        <div class="col col-md-auto">
                                            <nav class="nav nav-underline justify-content-end doc-tab-nav align-items-center"
                                                ...
                                                <a href="{{ route('exemption_form.create') }}"
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end py-2">
                                                                    @if(auth()->user()->exemption_form_edit == 1)
                                                                        ...
                                                                        <a class="dropdown-item"
                                                                           href="{{ route('exemption_form.edit',$row->id) }}">Edit</a>
                                                                    ...
                                                                    @endif
                                                                        ...
                                                                        @endif
                                                                    @if(auth()->user()->exemption_form_delete == 1)

                                                                        <form id="deleteForm-{{ $row->id }}"
                                                                              action="{{ route('exemption_form.destroy',$row->id) }}"
                                                                              method="Post">
                                                                            @csrf
                                                                            @method('DELETE')
