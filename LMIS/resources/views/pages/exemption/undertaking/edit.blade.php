                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="p-4 code-to-copy">
                                ...
                                <form class="row g-3 needs-validation"
                                    method="post" action="{{ route('undertaking.update',$undertaking->id) }}" novalidate=""
                                        ...
                                        <div class="col-md-12">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input class="form-control" id="doc_no" type="text" name="doc_no" value="{{$undertaking->doc_no}}" readonly required="" />
                                                ...
                                                <div class="col-md-4">
                                                        ...
                                                        <select id="base_doc_no" name="base_doc_no" class="form-control"
                                                            ...
                                                            @foreach($conveyance as $row)
                                                                <option @if($undertaking->base_doc_no ==  $row->doc_no) selected @endif value="{{ $row->doc_no }}">File No - {{ $row->doc_no }}</option>
                                                            @endforeach
                                                        </select>
