                                ...
                                <div class="p-4 code-to-copy">
                                    ...
                                    @endif
                                        <form onsubmit="return validateForm()" class="row g-3 needs-validation"
                                              method="post" action="{{ route('intimation_application.update',$intimation_application->id) }}" novalidate=""
                                            ...
                                            <div class="col-md-12">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input class="form-control" id="doc_no" type="text" name="doc_no"  value="{{$intimation_application->doc_no}}"  readonly required="" />
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input class="form-control" id="date" type="date"
                                                               name="date" required=""
                                                               value="{{$intimation_application->date}}"/>
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="hidden" id="lo_name" name="lo_name" value="{{$intimation_application->lo_name}}">
                                                        ...
                                                        <select id="base_doc_no" name="lo_code" class="form-control"
                                                            ...
                                                            @foreach($seller_profile as $row)
                                                                <option @if($intimation_application->lo_code == $row->lo_cod  ) selected @endif value="{{ $row->lo_cod }}"> {{ $row->lo_name }}</option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="mb-3">
                                                            ...
                                                            <input class="form-control"
                                                                   ...
                                                                   name="lo_father_name"
                                                                   type="text"
                                                                   value="{{ $intimation_application->lo_father_name}}"
                                                                   required=""/>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="mb-3">
                                                            ...
                                                            <input class="form-control"
                                                                   ...
                                                                   name="lo_cnic"
                                                                   type="text" 
                                                                   value="{{ $intimation_application->lo_cnic}}"
                                                                   required=""/>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input class="form-control"
                                                                   ...
                                                                   name="file_no"
                                                                   type="text"
                                                                   value="{{ $intimation_application->file_no}}"
                                                                   required=""/>
                                                        </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input class="form-control"
                                                                   ...
                                                                   name="code_no"
                                                                   type="text" 
                                                                   value="{{ $intimation_application->code_no}}"
                                                                   required=""/>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input class="form-control"
                                                                   ...
                                                                   name="attachment"
                                                                   type="file"
                                                                   value="{{ $intimation_application->attachment}}"
                                                                   />
                                                            @if($intimation_application->attachment)

                                                                <?php
                                                                $filename = $intimation_application->attachment;
                                                                $extension = pathinfo($filename, PATHINFO_EXTENSION);

                                                                ?>
                                                                @if(in_array($extension, ['jpg', 'jpeg', 'png', 'gif']))
                                                                    <img src="{{ URL::asset('public/assets/uploads/').'/'.$intimation_application->attachment; }}"
                                                                         style="width: 294px;  border: 1px solid #CBD0DD;  border-radius: 4px;">
                                                                @else
                                                                    <a target="_blank"
                                                                       href="{{ URL::asset('public/assets/uploads/').'/'.$intimation_application->attachment; }}">
                                                                        <img src="{{ URL::asset('public/assets/').'/'.'file.png'; }}"
                                                                             style="width: 294px;  border: 1px solid #CBD0DD;  border-radius: 4px;">
                                                                    </a>
                                                                @endif
                                                                {{--<img src="{{ URL::asset('public/assets/uploads/').'/'.$intimation_application->attachment; }}" style="width: 294px;  border: 1px solid #CBD0DD;  border-radius: 4px;">--}}
                                                            @endif
                                                        </div>
