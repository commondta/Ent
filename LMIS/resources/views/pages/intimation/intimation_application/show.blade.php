                                    ...
                                    @if(auth()->user()->intimation_application_add == 1)
                                        ...
                                        <div class="col col-md-auto">
                                            <nav class="nav nav-underline justify-content-end doc-tab-nav align-items-center"
                                                ...
                                                <a href="{{ route('intimation_application.create') }}"
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end py-2">
                                                                    @if(auth()->user()->intimation_application_edit == 1)
                                                                        ...
                                                                        <a class="dropdown-item"
                                                                           href="{{ route('intimation_application.edit',$row->id) }}">Edit</a>
                                                                    ...
                                                                    @endif
                                                                        ...
                                                                        @endif
                                                                    @if(auth()->user()->intimation_application_delete == 1)

                                                                        <form id="deleteForm-{{ $row->id }}"
                                                                              action="{{ route('intimation_application.destroy',$row->id) }}"
                                                                              method="Post">
                                                                            @csrf
                                                                            @method('DELETE')
