                                    ...
                                    @if(auth()->user()->intimation_letter_add == 1)
                                        ...
                                        <div class="col col-md-auto">
                                            <nav class="nav nav-underline justify-content-end doc-tab-nav align-items-center"
                                                ...
                                                <a href="{{ route('intimation_letter.create') }}"
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end py-2">
                                                                    @if(auth()->user()->intimation_letter_edit == 1)
                                                                        ...
                                                                        <a class="dropdown-item"
                                                                           href="{{ route('intimation_letter.edit',$row->id) }}">Edit</a>
                                                                    ...
                                                                    @endif
                                                                        ...
                                                                        @endif
                                                                    @if(auth()->user()->intimation_letter_delete == 1)

                                                                        <form  id="deleteForm-{{ $row->id }}"
                                                                               action="{{ route('intimation_letter.destroy',$row->id) }}"
                                                                              method="Post">
                                                                            @csrf
                                                                            @method('DELETE')
