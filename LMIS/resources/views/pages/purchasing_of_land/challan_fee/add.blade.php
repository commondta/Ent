                        ...
                        <div class="card shadow-none border border-300 my-4" data-component-card="data-component-card">
                            ...
                            <div class="card-body p-0">
                                ...
                                <div class="p-4 code-to-copy">
                                    ...
                                    @endif
                                    <form class="row g-3 needs-validation" method="post" action="{{ route('challan_fee.store') }}" novalidate=""  enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <input class="form-control" id="sr_code" type="text" name="sr_code" readonly value="{{$sr_code+1}}" required="" />
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <input class="form-control" id="amount" type="text" name="amount" value="{{ old('amount') }}" required="" />
