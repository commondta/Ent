                                ...
                                <div class="p-4 code-to-copy">
                                    ...
                                    @endif
                                        <form onsubmit="return validateForm()" class="row g-3 needs-validation"
                                              method="post" action="{{ route('challan_form.update',$header->id) }}" novalidate=""
                                            ...
                                            <div class="col-md-12">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <input class="form-control" id="challan_no" type="text" name="challan_no" readonly value="{{$header->challan_no}}" required="" />
                                                        @error('doc_no')
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <input class="form-control" id="doc_date" type="text" name="date" required="" readonly value="{{ date('Y-m-d', strtotime($header->date)) }}"/>
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <input type="hidden" name="seller_name" id="seller_name" value="{{$header->seller_name}}">
                                                        <select onchange="addSellerinfo(this)" name="seller_id" class="form-control" required>
                                                            ...
                                                            @foreach($seller_profiles as $seller_profile)
                                                                <option @if($header->seller_id == $seller_profile->id ) selected @endif data-seller_name="{{$seller_profile->lo_name.' ' . $seller_profile->lo_father_name}}" data-cnic="{{$seller_profile->lo_cnic}}" value="{{$seller_profile->id}}">{{$seller_profile->lo_name.' ' . $seller_profile->lo_father_name}}</option>
                                                            @endforeach
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <input class="form-control"  id="seller_cnic" type="text" name="seller_cnic" required="" readonly value="{{$header->seller_cnic}}"/>
                                                        {{--<div class="invalid-feedback">Please add Date.</div>--}}
                                                        @error('date')
                                                        <div style="width: 100%; margin-top: 0.25rem;  font-size: 75%; color: var(--lm-danger);" >{{ $message }}</div>
                                                        @enderror
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <table>
                                                                    ...
                                                                    <tr id="1">
                                                                        <td>1 </td>
                                                                        <td><select onchange="addamount(this,'<?php echo $count; ?>')"  name="challan_form_row[<?php echo $count; ?>][challan_type]"  class="form-control"><option value="">Select Challan Type</option>@foreach($challan_fee as $row)<option @if($row_data['challan_type'] == $row->category ) selected @endif data-amount_<?php echo $count; ?>="{{$row->amount}}" {{$row->id}}>{{$row->category}}</option>@endforeach </select> </td>
                                                                        <td><input onchange="calculateTotal()" class="row-level amount form-control" id="amount_<?php echo $count; ?>"  name="challan_form_row[<?php echo $count; ?>][amount]"   value="{{ $row_data['amount'] }}"> </td>
                                                                    </tr>
                                                                    <?php $count++; ?>
                                                                ...
                                                                <div class="col-md-2">
                                                                    ...
                                                                    <input class="form-control"  id="total" type="text" name="amount" required="" readonly value="{{ $header->amount }}"/>
                                                                    {{--<div class="invalid-feedback">Please add Date.</div>--}}
                                                                    @error('date')
                                                                    <div style="width: 100%; margin-top: 0.25rem;  font-size: 75%; color: var(--lm-danger);" >{{ $message }}</div>
                                                                    @enderror
