                                    ...
                                    <div class="col col-md-auto">
                                        <nav class="nav nav-underline justify-content-end doc-tab-nav align-items-center"
                                            ...
                                            @if(auth()->user()->challan_form_add == 1)
                                                ...
                                                <a href="{{ route('challan_form.create') }}"
                                                        ...
                                                        <td class="align-middle white-space-nowrap text-end pe-0">
                                                            <div class="font-sans-serif btn-reveal-trigger position-static">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end py-2">
                                                                    @if(auth()->user()->challan_form_edit == 1)

                                                                        <a class="dropdown-item"
                                                                           href="{{ route('challan_form.edit',$row->id) }}">Edit</a>
                                                                    @endif

                                                                    @if(auth()->user()->challan_form_print == 1)

                                                                        <a target="_blank" class="dropdown-item"
                                                                           href="{{ route('challan_form.show',$row->id) }}">Print</a>
                                                                    @endif
                                                                        ...
                                                                        @endif
                                                                    @if(auth()->user()->challan_form_delete == 1)

                                                                        <form id="deleteForm-{{ $row->id }}"
                                                                              action="{{ route('challan_form.destroy',$row->id) }}"
                                                                              method="Post">
                                                                            @csrf
                                                                            @method('DELETE')
