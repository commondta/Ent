                        ...
                        <div class="card shadow-none border border-300 my-4" data-component-card="data-component-card">
                            ...
                            <div class="card-body p-0">
                                ...
                                <div class="p-4 code-to-copy">
                                    ...
                                    @endif
                                    <form class="row g-3 needs-validation" method="post" action="{{ route('exemption_rate.store') }}" novalidate=""  enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <input class="form-control" id="mouza_code" type="text" name="mouza_code" readonly value="{{$doc_num+1}}" required="" />
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <input class="form-control" id="mouza_name" type="text" name="mouza_name" value="{{ old('mouza_name') }}" required="" />
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <input class="form-control" id="exemption_rate" type="text" name="exemption_rate" value="{{ old('exemption_rate') }}" required="" />
