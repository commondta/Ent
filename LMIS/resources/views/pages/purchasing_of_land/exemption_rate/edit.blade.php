                        ...
                        <div class="card shadow-none border border-300 my-4" data-component-card="data-component-card">
                            ...
                            <div class="card-body p-0">
                                ...
                                <div class="p-4 code-to-copy">
                                    ...
                                    @endif
                                    <form class="row g-3 needs-validation" method="post" action="{{ route('exemption_rate.update',$exemption_rate->id) }}" novalidate=""  enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <label class="form-label" for="mouza_code">Doc No</label>
                                                        <input class="form-control" id="mouza_code" type="text" name="mouza_code" readonly value="{{$exemption_rate->mouza_code}}" required="" />
                                                    ...
                                                    <div class="col-md-4">
                                                        <label class="form-label" for="mouza_name">Mouza Name</label>
                                                        <input class="form-control" id="mouza_name" type="text" name="mouza_name" value="{{$exemption_rate->mouza_name}}"  required="" />
                                                        <div class="invalid-feedback">Please add Mouza Name.</div>
                                                        @error('mouza_name')
                                                        <div style="width: 100%; margin-top: 0.25rem;  font-size: 75%; color: var(--lm-danger);" >{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <input class="form-control" id="exemption_rate" type="text" name="exemption_rate"  value="{{$exemption_rate->exemption_rate}}"  required="" />
                                                        <div class="invalid-feedback">Please add Exemption Rate.</div>
                                                        @error('exemption_rate')
                                                        <div style="width: 100%; margin-top: 0.25rem;  font-size: 75%; color: var(--lm-danger);" >{{ $message }}</div>
                                                        @enderror
                                                    </div>
