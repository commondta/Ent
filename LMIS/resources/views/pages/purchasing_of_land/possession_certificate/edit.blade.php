                    ...
                    <div class="card shadow-none border border-300 my-4" data-component-card="data-component-card">
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="p-4 code-to-copy">
                                ...
                                @endif
                                <form class="row g-3 needs-validation" method="post" action="{{ route('possession_certificate.update',$possession_certificate->id) }}" novalidate="" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input class="form-control" id="doc_no" type="text" name="doc_no" readonly value="{{ $possession_certificate->doc_no }}" required="" />
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input class="form-control" id="date" type="text"
                                                        ...
                                                        value="{{ $possession_certificate->date }}" />
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <select id="base_code_no" name="base_code_no" class="form-control"
                                                        ...
                                                        <option @if($possession_certificate->base_code_no == $row->doc_no) selected @endif value="{{ $row->doc_no }}">File No - {{ $row->doc_no }}</option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control"
                                                            ...
                                                            name="mouza"
                                                            type="text"
                                                            value="{{ $possession_certificate->mouza }}"
                                                            required="" />
                                                    </div>
                                                                    ...
                                                                    <div style="overflow-x: auto; -webkit-overflow-scrolling: touch;">
                                                                        <table class=" table-bordered table-sm" id="landDetailsTable" style="border: 1px solid var(--lm-border); margin-bottom: 0; min-width: 100%;">
                                                                            ...
                                                                            <tbody id="landDetailsBody">
                                                                                ...
                                                                                <tr style="border: 1px solid var(--lm-border);">
                                                                                    ...
                                                                                    <td style="border:1px solid var(--lm-border); padding:0;">
                                                                                        <input type="text" class="form-control" name="land_details[{{ $index }}][khewat_no]" value="{{ $detail->khewat_no }}" readonly style="border:none; border-radius:0;">
                                                                                    </td>

                                                                                    <td style="border:1px solid var(--lm-border); padding:0;">
                                                                                        <input type="text" class="form-control" name="land_details[{{ $index }}][khatooni_no]" value="{{ $detail->khatooni_no }}" readonly style="border:none; border-radius:0;">
                                                                                    </td>



                                                                                    <td style="border:1px solid var(--lm-border); padding:0;">
                                                                                        <input type="text" class="form-control" name="land_details[{{ $index }}][qatat]" value="{{ $detail->qatat }}" readonly style="border:none; border-radius:0;">
                                                                                    </td>
                                                                                    <td style="border:1px solid var(--lm-border); padding:0;">
                                                                                        <input type="text" class="form-control" name="land_details[{{ $index }}][sector]" value="{{ $detail->sector }}" style="border:none; border-radius:0;">
                                                                                    </td>
                                                                                    <td style="border:1px solid var(--lm-border); padding:0;">
                                                                                        <select class="form-control readonly-select" name="land_details[{{ $index }}][land_category]" style="border:none; border-radius:0;">
                                                                                            <option value="">Select</option>
                                                                                            <option value="Ownership" {{ $detail->land_category == 'Ownership' ? 'selected' : '' }}>Ownership</option>
                                                                                            <option value="Non Pata" {{ $detail->land_category == 'Non Pata' ? 'selected' : '' }}>Non Pata</option>
                                                                                            <option value="Govt Land" {{ $detail->land_category == 'Govt Land' ? 'selected' : '' }}>Govt Land</option>
                                                                                        </select>
                                                                                    </td>


                                                                                    <td style="border:1px solid var(--lm-border); padding:0;">
                                                                                        <input type="text" class="form-control" name="land_details[{{ $index }}][land_measuring_k]" value="{{ $detail->land_measuring_k }}" readonly style="border:none; border-radius:0;">
                                                                                    </td>

                                                                                    <td style="border:1px solid var(--lm-border); padding:0;">
                                                                                        <input type="text" class="form-control" name="land_details[{{ $index }}][land_measuring_m]" value="{{ $detail->land_measuring_m }}" readonly style="border:none; border-radius:0;">
                                                                                    </td>

                                                                                    <td style="border:1px solid var(--lm-border); padding:0;">
                                                                                        <input type="text" class="form-control" name="land_details[{{ $index }}][land_measuring_sqft]" value="{{ $detail->land_measuring_sqft }}" readonly style="border:none; border-radius:0;">
                                                                                    </td>
                                                                                    ...
                                                                                    <!--  Possessed Land -->
                                                                                    <td style="border:1px solid var(--lm-border); padding:0;">
                                                                                        <input type="text" class="form-control" name="land_details[{{ $index }}][possessed_k]" value="{{ $detail->possessed_k }}" required="" style="border:none; border-radius:0;">
                                                                                    </td>

                                                                                    <td style="border:1px solid var(--lm-border); padding:0;">
                                                                                        <input type="text" class="form-control" name="land_details[{{ $index }}][possessed_m]" value="{{ $detail->possessed_m }}" required="" style="border:none; border-radius:0;">
                                                                                    </td>

                                                                                    <td style="border:1px solid var(--lm-border); padding:0;">
                                                                                        <input type="text" class="form-control" name="land_details[{{ $index }}][possessed_sqft]" value="{{ $detail->possessed_sqft }}" required="" style="border:none; border-radius:0;">
                                                                                    </td>

                                                                                    <!--  Unpossessed Land -->
                                                                                    <td style="border:1px solid var(--lm-border); padding:0;">
                                                                                        <input type="text" class="form-control" name="land_details[{{ $index }}][unpossessed_k]" value="{{ $detail->unpossessed_k }}" readonly style="border:none; border-radius:0;">
                                                                                    </td>

                                                                                    <td style="border:1px solid var(--lm-border); padding:0;">
                                                                                        <input type="text" class="form-control" name="land_details[{{ $index }}][unpossessed_m]" value="{{ $detail->unpossessed_m }}" readonly style="border:none; border-radius:0;">
                                                                                    </td>

                                                                                    <td style="border:1px solid var(--lm-border); padding:0;">
                                                                                        <input type="text" class="form-control" name="land_details[{{ $index }}][unpossessed_sqft]" readonly value="{{ $detail->unpossessed_sqft }}" style="border:none; border-radius:0;">
                                                                                    </td>
                                                                                ...
                                                                                <tr style="border: 1px solid var(--lm-border);">
                                                                                    ...
                                                                                    <td style="border:1px solid var(--lm-border); padding:0;">
                                                                                        <input type="text" class="form-control" name="land_details[0][khewat_no]" style="border:none; border-radius:0;">
                                                                                    </td>

                                                                                    <td style="border:1px solid var(--lm-border); padding:0;">
                                                                                        <input type="text" class="form-control" name="land_details[0][khatooni_no]" style="border:none; border-radius:0;">
                                                                                    </td>


                                                                                    <td style="border:1px solid var(--lm-border); padding:0;">
                                                                                        <input type="text" class="form-control" name="land_details[0][qatat]" style="border:none; border-radius:0;">
                                                                                    </td>
                                                                                    <td style="border:1px solid var(--lm-border); padding:0;">
                                                                                        <input type="text" class="form-control" name="land_details[0][sector]" style="border:none; border-radius:0;">
                                                                                    </td>
                                                                                    <td style="border:1px solid var(--lm-border); padding:0;">
                                                                                        <select class="form-control" name="land_details[0][land_category]" style="border:none; border-radius:0;">
                                                                                            <option value="">Select</option>
                                                                                    ...
                                                                                    <td style="border:1px solid var(--lm-border); padding:0;">
                                                                                        <input type="text" class="form-control" name="land_details[0][land_measuring_k]" style="border:none; border-radius:0;">
                                                                                    </td>

                                                                                    <td style="border:1px solid var(--lm-border); padding:0;">
                                                                                        <input type="text" class="form-control" name="land_details[0][land_measuring_m]" style="border:none; border-radius:0;">
                                                                                    </td>

                                                                                    <td style="border:1px solid var(--lm-border); padding:0;">
                                                                                        <input type="text" class="form-control" name="land_details[0][land_measuring_sqft]" style="border:none; border-radius:0;">
                                                                                    </td>
                                                                                    ...
                                                                                    <!--  Possessed Land -->
                                                                                    <td style="border:1px solid var(--lm-border); padding:0;">
                                                                                        <input type="text" class="form-control" name="land_details[0][possessed_k]" style="border:none; border-radius:0;">
                                                                                    </td>

                                                                                    <td style="border:1px solid var(--lm-border); padding:0;">
                                                                                        <input type="text" class="form-control" name="land_details[0][possessed_m]" style="border:none; border-radius:0;">
                                                                                    </td>

                                                                                    <td style="border:1px solid var(--lm-border); padding:0;">
                                                                                        <input type="text" class="form-control" name="land_details[0][possessed_sqft]" style="border:none; border-radius:0;">
                                                                                    </td>

                                                                                    <!--  Unpossessed Land -->
                                                                                    <td style="border:1px solid var(--lm-border); padding:0;">
                                                                                        <input type="text" class="form-control" name="land_details[0][unpossessed_k]" readonly style="border:none; border-radius:0;">
                                                                                    </td>

                                                                                    <td style="border:1px solid var(--lm-border); padding:0;">
                                                                                        <input type="text" class="form-control" name="land_details[0][unpossessed_m]" readonly style="border:none; border-radius:0;">
                                                                                    </td>

                                                                                    <td style="border:1px solid var(--lm-border); padding:0;">
                                                                                        <input type="text" class="form-control" name="land_details[0][unpossessed_sqft]" readonly style="border:none; border-radius:0;">
                                                                                    </td>
                                                                            ...
                                                                            <tfoot>
                                                                                ...
                                                                                <tr style="background: var(--lm-surface);font-weight:bold">
                                                                                    <td colspan="5" style="text-align:right;border:1px solid var(--lm-border);">Acres Totals</td>

                                                                                    <!-- Land Acres Total -->
                                                                                    <td colspan="3" style="border:1px solid var(--lm-border);">
                                                                                        <input type="text" id="total_land_acres" class="form-control" readonly>
                                                                                    </td>

                                                                                    <!-- Possessed Acres Total -->
                                                                                    <td colspan="3" style="border:1px solid var(--lm-border);">
                                                                                        <input type="text" id="total_poss_acres" class="form-control" readonly>
                                                                                    </td>

                                                                                    <!-- Unpossessed Acres Total -->
                                                                                    <td colspan="3" style="border:1px solid var(--lm-border);">
                                                                                        <input type="text" id="total_unposs_acres" class="form-control" readonly>
                                                                                    </td>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <select id="lp_name" name="lp_name" class="form-control"
                                                                        ...
                                                                        <option @if($possession_certificate->lp_name == $row->lp_cod) selected @endif value="{{ $row->lp_cod }}">{{ $row->lp_name }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input class="form-control"
                                                                            ...
                                                                            name="lp_contact_no"
                                                                            type="text" min="0"
                                                                            value="{{ $possession_certificate->lp_contact_no }}"
                                                                             />
                                                                    </div>
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input class="form-control"
                                                                            ...
                                                                            name="lp_rep_name"
                                                                            type="text"
                                                                            value="{{ $possession_certificate->lp_rep_name }}"
                                                                            required="" />
                                                                    </div>
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input class="form-control"
                                                                            ...
                                                                            type="text"
                                                                            value="{{ $possession_certificate->lp_possession_jpo }}"
                                                                            required="" />
                                                                    </div>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="align-middle ps-3 name"><?php
                                                                                                        ...
                                                                                                        if ($signle->document == 'attachment_possession_certificate') {
                                                                                                            echo 'Possession Certificate';
                                                                                                        }
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <input class="form-control" id="picto_lo_name" type="text" name="picto_lo_name" value="{{ $possession_certificate->picto_lo_name }}" required="" />
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <input class="form-control" id="picto_lp_name" type="text" name="picto_lp_name" value="{{ $possession_certificate->picto_lp_name }}" required="" />
                                                                    <div class="invalid-feedback">Please add LP Name.</div>
                                                                    @error('picto_lp_name')
                                                                    <div style="width: 100%; margin-top: 0.25rem;  font-size: 75%; color: var(--lm-danger);">{{ $message }}</div>
                                                                    @enderror
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <input class="form-control" id="picto_name_of_patwari" type="text" name="picto_name_of_patwari" value="{{ $possession_certificate->picto_name_of_patwari }}" required="" />
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <input class="form-control" id="picto_possession_jco" type="text" name="picto_possession_jco" value="{{ $possession_certificate->picto_possession_jco }}" required="" />
                                                                ...
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input class="form-control"
                                                                            ...
                                                                            name="picto_picture"
                                                                            type="file"
                                                                            value="{{ $possession_certificate->picto_picture }}" />
                                                                        @if($possession_certificate->picto_picture)
                                                                        <?php
                                                                        $filename = $possession_certificate->picto_picture;
                                                                        $extension = pathinfo($filename, PATHINFO_EXTENSION);

                                                                        ?>
                                                                        @if(in_array($extension, ['jpg', 'jpeg', 'png', 'gif']))
                                                                        <img src="{{ URL::asset('public/assets/uploads/').'/'.$possession_certificate->picto_picture; }}"
                                                                            style="width: 200px;  border: 1px solid #CBD0DD;  border-radius: 4px;">
                                                                        @else
                                                                        <a target="_blank"
                                                                            href="{{ URL::asset('public/assets/uploads/').'/'.$possession_certificate->picto_picture; }}">
                                                                            <img src="{{ URL::asset('public/assets/').'/'.'file.png'; }}"
                                                                                style="width: 200px;  border: 1px solid #CBD0DD;  border-radius: 4px;">
                                                                        </a>
                                                                        @endif
                                                                        {{-- <img src="{{ URL::asset('public/assets/uploads/').'/'.$possession_certificate->picture; }}" style="width: 295px; border: 1px solid #CBD0DD; border-radius: 4px;">--}}
                                                                        @endif
                                                                    </div>
                                    ...
                                    <!-- Hidden fields for totals - Pre-populated with existing values -->
                                    <input type="hidden" id="hidden_total_land_kanal" name="total_land_kanal" value="{{ $possession_certificate->total_land_kanal ?? '' }}">
                                    <input type="hidden" id="hidden_total_land_marla" name="total_land_marla" value="{{ $possession_certificate->total_land_marla ?? '' }}">
                                    <input type="hidden" id="hidden_total_land_sqft" name="total_land_sqft" value="{{ $possession_certificate->total_land_sqft ?? '' }}">
                                    <input type="hidden" id="hidden_total_land_acres" name="total_land_acres" value="{{ $possession_certificate->total_land_acres ?? '' }}">
                                    <input type="hidden" id="hidden_total_poss_kanal" name="total_poss_kanal" value="{{ $possession_certificate->total_poss_kanal ?? '' }}">
                                    <input type="hidden" id="hidden_total_poss_marla" name="total_poss_marla" value="{{ $possession_certificate->total_poss_marla ?? '' }}">
                                    <input type="hidden" id="hidden_total_poss_sqft" name="total_poss_sqft" value="{{ $possession_certificate->total_poss_sqft ?? '' }}">
                                    <input type="hidden" id="hidden_total_poss_acres" name="total_poss_acres" value="{{ $possession_certificate->total_poss_acres ?? '' }}">
                                    <input type="hidden" id="hidden_total_unposs_kanal" name="total_unposs_kanal" value="{{ $possession_certificate->total_unposs_kanal ?? '' }}">
                                    <input type="hidden" id="hidden_total_unposs_marla" name="total_unposs_marla" value="{{ $possession_certificate->total_unposs_marla ?? '' }}">
                                    <input type="hidden" id="hidden_total_unposs_sqft" name="total_unposs_sqft" value="{{ $possession_certificate->total_unposs_sqft ?? '' }}">
                                    <input type="hidden" id="hidden_total_unposs_acres" name="total_unposs_acres" value="{{ $possession_certificate->total_unposs_acres ?? '' }}">
...
<script>
    $(document).ready(function() {
        ...
        // Remove previous change handlers (IMPORTANT FIX)
        $('#base_code_no').off('change.loinfo');

        // Add namespaced event
        $('#base_code_no').on('change.loinfo', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    tbodyLoInfo.empty(); // extra safety clear
                ...
                error: function() {
                    ...
                    <tr>
                        <td colspan="4" class="text-center text-danger">
                            Error fetching Land Owner data
                        </td>
                    </tr>
                `);
                }
        ...
        // Trigger ONLY ONCE on edit page
        if ($('#base_code_no').val()) {
            $('#base_code_no').trigger('change.loinfo');
        }
...
-->
                            ...
                            <td><input type="text" class="form-control" name="land_details[${index}][possessed_k]" value=""></td>
                            <td><input type="text" class="form-control" name="land_details[${index}][possessed_m]" value=""></td>
                            <td><input type="text" class="form-control" name="land_details[${index}][possessed_sqft]" value=""></td>
    ...
    // Initialize acres display fields with existing database values on page load
    $(document).ready(function() {
        var totalLandAcres = '{{ $possession_certificate->total_land_acres ?? "" }}';
        var totalPossAcres = '{{ $possession_certificate->total_poss_acres ?? "" }}';
        var totalUnpossAcres = '{{ $possession_certificate->total_unposs_acres ?? "" }}';

        if (totalLandAcres) {
            $('#total_land_acres').val(totalLandAcres);
            $('#hidden_total_land_acres').val(totalLandAcres);
        }
        if (totalPossAcres) {
            $('#total_poss_acres').val(totalPossAcres);
            $('#hidden_total_poss_acres').val(totalPossAcres);
        }
        if (totalUnpossAcres) {
            $('#total_unposs_acres').val(totalUnpossAcres);
            $('#hidden_total_unposs_acres').val(totalUnpossAcres);
        }
    });
    // Remove row function
...
<script>
    $(document).ready(function() {
        ...
        function calculateColumnTotals() {
            ...
            $('#total_land_acres').val(parseFloat(landAcres).toFixed(2));
            $('#total_poss_acres').val(parseFloat(possAcres).toFixed(2));
            $('#total_unposs_acres').val(parseFloat(unpossAcres).toFixed(2));
            ...
            $('#hidden_total_land_acres').val(parseFloat(landAcres).toFixed(2));
            ...
            $('#hidden_total_poss_acres').val(parseFloat(possAcres).toFixed(2));
            ...
            $('#hidden_total_unposs_acres').val(parseFloat(unpossAcres).toFixed(2));
        }
        ...
        // Initialize totals on page load (for edit page with existing data)
        calculateColumnTotals();
