                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="p-4 code-to-copy">
                                ...
                                <form onsubmit="return validateForm()" class="row g-3 needs-validation"
                                    method="post" action="{{ route('purchase_of_land.store') }}" novalidate=""
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    ...
                                                    <input class="form-control" id="File_No" type="text"
                                                        name="File_No" readonly value="{{$file_num+1}}" required="" />
                                                ...
                                                <div class="col-md-6">
                                                    <label class="form-label" for="land_form_no">Land Form NO</label>
                                                    <select name="land_form_no" id="land_form_no" class="form-control" required>
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <input class="form-control" id="district_rate" type="number" step="0.01" name="district_rate"
                                                        required value="{{ old('district_rate') }}" />
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <input class="form-control" id="district_amount" type="number" step="0.01" name="district_amount"
                                                        required value="{{ old('district_amount') }}" />
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <input class="form-control" id="society_rate" type="number" step="0.01" name="society_rate"
                                                        required readonly value="{{ old('society_rate') }}" />
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <input class="form-control" id="society_amount" type="number" step="0.01" name="society_amount"
                                                        required readonly value="{{ old('society_amount') }}" />
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <input
                                                        ...
                                                        value="{{ old('exemption_rate', $Land_form->exemption_rate ?? '') }}"
                                                        required>
                                            ...
                                            <div class="col-md-12" style="margin-top: 20px">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                                <label class="form-label" for="fard_id">Fard Id 1</label>
                                                                <input class="form-control" id="fard_id" type="text"
                                                                    name="fard_id" required="" value="{{ old('fard_id') }}" />
                                                            ...
                                                            <div class="col-md-3">
                                                                ...
                                                                <input class="form-control" id="fard_id2" type="text"
                                                                    name="fard_id2" value="{{ old('fard_id2') }}" />
                                                                <div class="invalid-feedback">Please Add Fard Id</div>
                                                                @error('fard_id2')
                                                                <div style="width: 100%; margin-top: 0.25rem;  font-size: 75%; color: var(--lm-danger);">{{ $message }}</div>
                                                                @enderror
                                                            ...
                                                            <div class="col-md-3">
                                                                ...
                                                                <div class="invalid-feedback">Please Add Fard Date 2</div>
                                                                @error('fard_date2')
                                                                <div style="width: 100%; margin-top: 0.25rem;  font-size: 75%; color: var(--lm-danger);">{{ $message }}</div>
                                                                @enderror
                                                            </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div style="overflow-x: auto; -webkit-overflow-scrolling: touch;">
                                                                            <table class="table-bordered table-sm" id="landDetailsTable" style="border: 1px solid var(--lm-border); margin-bottom: 0; min-width: 100%;">
                                                                                ...
                                                                                <tbody id="tbodyrow">
                                                                                    <tr id="1">
                                                                                        <td style="width: 100px; border: 1px solid var(--lm-border);"><input class="row-level form-control" name="land_details[1][khewat_no]" value="{{ old('land_details[1][khewat_no]') }}" style="border-radius: 0; border: none; margin: 0; height: 100%; padding: 4px;"></td>
                                                                                        <td style="width: 100px; border: 1px solid var(--lm-border);"><input class="row-level form-control" name="land_details[1][khatooni_no]" value="{{ old('land_details[1][khatooni_no]') }}" style="border-radius: 0; border: none; margin: 0; height: 100%; padding: 4px;"></td>
                                                                                        <td style="width: 100px; border: 1px solid var(--lm-border);"><input class="row-level form-control" name="land_details[1][qatat]" value="{{ old('land_details[1][qatat]') }}" style="border-radius: 0; border: none; margin: 0; height: 100%; padding: 4px;"></td>
                                                                                        <td style="width: 80px; border: 1px solid var(--lm-border);"><input class="row-level form-control" name="land_details[1][measuring_k]" value="{{ old('land_details[1][measuring_k]') }}" style="border-radius: 0; border: none; margin: 0; height: 100%; padding: 4px;"></td>
                                                                                        <td style="width: 80px; border: 1px solid var(--lm-border);"><input class="row-level form-control" name="land_details[1][measuring_m]" value="{{ old('land_details[1][measuring_m]') }}" style="border-radius: 0; border: none; margin: 0; height: 100%; padding: 4px;"></td>
                                                                                        <td style="width: 80px; border: 1px solid var(--lm-border);"><input class="row-level form-control" name="land_details[1][measuring_sqft]" value="{{ old('land_details[1][measuring_sqft]') }}" style="border-radius: 0; border: none; margin: 0; height: 100%; padding: 4px;"></td>
                                                                                        <td style="width: 100px; border: 1px solid var(--lm-border);"><input class="row-level form-control" name="land_details[1][transfer_share]" value="{{ old('land_details[1][transfer_share]') }}" style="border-radius: 0; border: none; margin: 0; height: 100%; padding: 4px;"></td>
                                                                                        <td style="width: 80px; border: 1px solid var(--lm-border);"><input class="row-level form-control" name="land_details[1][land_measuring_k]" value="{{ old('land_details[1][land_measuring_k]') }}" style="border-radius: 0; border: none; margin: 0; height: 100%; padding: 4px;"></td>
                                                                                        <td style="width: 80px; border: 1px solid var(--lm-border);"><input class="row-level form-control" name="land_details[1][land_measuring_m]" value="{{ old('land_details[1][land_measuring_m]') }}" style="border-radius: 0; border: none; margin: 0; height: 100%; padding: 4px;"></td>
                                                                                        <td style="width: 80px; border: 1px solid var(--lm-border);"><input class="row-level form-control" name="land_details[1][land_measuring_sqft]" value="{{ old('land_details[1][land_measuring_sqft]') }}" style="border-radius: 0; border: none; margin: 0; height: 100%; padding: 4px;"></td>
                                                                                        <td style="width: 160px; border: 1px solid var(--lm-border); padding: 0px;">
                                                                                            <select class="form-control" name="land_details[1][land_category]" style="border-radius: 0; border: none; margin: 0; height: 100%; padding: 4px;">
                                                                                                ...
                                                                                                <option value="Ownership" @if(old('land_details.1.land_category')=='Ownership' ) selected @endif>Ownership</option>
                                                                                                <option value="Non Pata" @if(old('land_details.1.land_category')=='Non Pata' ) selected @endif>Non Pata</option>
                                                                                                <option value="Govt Land" @if(old('land_details.1.land_category')=='Govt Land' ) selected @endif>Govt Land</option>
                                                                                            </select>
                                                                                        </td>
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input class="form-control"
                                                                        ...
                                                                        type="file"
                                                                        multiple
                                                                        value="{{ old('attachment_nfc_sub_registrar') }}" />
                                                                </div>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="mb-3">
                                                                    <label class="form-label"
                                                                        for="attachment_massavi">Massavi</label>
                                                                    <input class="form-control"
                                                                        id="attachment_massavi"
                                                                        name="attachment_massavi[]"
                                                                        type="file"
                                                                        multiple
                                                                        value="{{ old('attachment_massavi') }}" />
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input class="form-control"
                                                                        ...
                                                                        type="file"
                                                                        multiple
                                                                        value="{{ old('attachment_aks_shajra') }}" />
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                ...
                                                                <div class="mb-3">
                                                                    <label class="form-label"
                                                                        for="attachment_girdwari">khasra
                                                                        Girdawari</label>
                                                                    <input class="form-control"
                                                                        id="attachment_girdwari"
                                                                        name="attachment_girdwari[]"
                                                                        type="file"
                                                                        multiple
                                                                        value="{{ old('attachment_girdwari') }}" />
                                                                </div>
                                                            ...
                                                            <div class="col-md-4">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input class="form-control"
                                                                        ...
                                                                        type="file"
                                                                        multiple
                                                                        value="{{ old('attachment_fard_milkiyat') }}" />
                                                                </div>
                                                            ...
                                                            <div class="col-md-4">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input class="form-control"
                                                                        ...
                                                                        type="file"
                                                                        multiple
                                                                        value="{{ old('attachment_khata_of_land') }}" />
                                                                </div>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.success) {
                        ...
                        ratePerAcre = 0;
                        $('#society_rate, #society_amount').val('');
                        alert('Rate not found for this Land Form No');
                    }
                },
                error: function() {
