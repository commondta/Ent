                    ...
                    <div class="card shadow-none border border-300 my-4" data-component-card="data-component-card">
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="p-4 code-to-copy">
                                ...
                                @endif
                                <form class="row g-3 needs-validation" method="post" action="{{ route('agreement.store') }}" novalidate="" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="mb-3">
                                                            ...
                                                            <input class="form-control"
                                                                ...
                                                                type="text"
                                                                value="{{ old('witness1_appointment') }}"
                                                                required="" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="mb-3">
                                                            ...
                                                            <input class="form-control"
                                                                ...
                                                                type="text"
                                                                value="{{ old('witness2_appointment') }}"
                                                                required="" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                ...
                                                <p><strong>Is land provider not {{ config('app.org_short') }}? <input type="checkbox" name="is_land_provider" value="1"></strong></p>
